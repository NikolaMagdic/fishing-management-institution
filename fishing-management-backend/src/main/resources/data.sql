...
INSERT INTO app_user (username, password, enabled) VALUES ('nikola', '$2a$10$/M2rdVYDZAI7DHPTZVfNUeo8SmEgjdqM.YXpkQOO7Tf/F6ip6/k16', true);
--
...
INSERT INTO fisherman (first_name, last_name, date_of_birth, address, city, category, user_id) VALUES ('Milan', 'Milanic', '1996-11-15', 'JNA 117', 'Ruma', 0, 3);
--
...
INSERT INTO fish_species (name, latin_name, category, min_size, max_quantity, max_weight, fishing_ban_start, fishing_ban_end, permanent_fishing_ban, image) VALUES ('Štuka', 'Esox lucius', 0, 40, 3, 5, '2023-03-01', '2023-03-31', false, 'https://zanimljiv.org/images/ribolov/stuka.gif');
